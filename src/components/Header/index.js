...
const Header = ({ modules, total, searchPokemon }) => {
    ...
    return (
        ...
        <Main>
            <div className="max-container">
                <Logo>
                    <Link to="/">
                    Poké<span>Store</span>
                    </Link>
                </Logo>
                <InputContainer>
                    <input type="text" className='field-search' placeholder="Pesquise seu pokémon..." value={url} onChange={handleUrl}/>
